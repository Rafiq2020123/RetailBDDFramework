...
@CucumberOptions(
		features ="C:\\All SOFTS\\com.tekschool.retail\\src\\test\\resources\\Features\\DatabaseConection.feature", // Features tells cucumber options where feature files are stored
		glue = {"stepDefinitions"}, // glue tells cucumber options where all Step Definitions class are stored 
		tags = {"@AAAAAA"}, // we can run all scenarios or one scenario with help of tags 
